...
test("preserves the current dock-threshold tail across compositor completion paths", () => {
  ...
  assert.equal(
    (result.match(/let o=this\.dockTarget,s=X5\(this\.anchor,this\.presentationOffset\);o!=null&&r5/g) ?? []).length,
    3,
  );
});
