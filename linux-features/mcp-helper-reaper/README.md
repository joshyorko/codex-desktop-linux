...
same-signature helpers are not treated as duplicates. Replaced app generations
and deleted helper generations remain eligible for cleanup. Orphan cleanup
