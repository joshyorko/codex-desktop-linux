...
const CURRENT_DICTATION_ASSET_PATTERN =
  /^app-initial~avatarOverlayCompositionSurface~app-main~new-thread-panel-page~onboarding-page~~e9wvq029-[^.]+\.js$/;
...
const CURRENT_ASSISTANT_ASSET_PATTERN =
  /^app-initial~app-main~onboarding-page~hotkey-window-thread-page~quick-chat-window-page~chatg~c33rimzq-[^.]+\.js$/;
